...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name', type=str, default='label-city',
                                 help='name of the experiment. It decides where to store samples and models')
        self.parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        self.parser.add_argument('--model', type=str, default='CycleGAN', help='chooses which model to use.')
        ...
        self.parser.add_argument('--dataroot', required=True,
                                 help='path to images (should have subfolders trainA, trainB, testA, testB, etc)')
        self.parser.add_argument('--resize_or_crop', type=str, default='scale_width',
                                 help='scaling and cropping of images at load time [resize|crop|scale_width|scale_width_and_crop]')
        ...
        # fot generator
        self.parser.add_argument('--netG_A', type=str, default='global', help='selects model to use for netG_A')
        self.parser.add_argument('--netG_B', type=str, default='global', help='selects model to use for netG_B')
